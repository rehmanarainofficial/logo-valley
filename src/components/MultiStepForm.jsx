...
const MultiStepForm = ({ selectedPackage }) => {
  ...
  const budgetRanges = ["Under $100", "$100 - $300", "$300 - $500", "$500+"];
  ...
  const handleSubmit = (e) => {
    ...
    const message =
      `*Logo Valley Project Inquiry Brief*\n\n` +
          ...
          <div className="relative rounded-3xl bg-[#141414] border border-[#C8A96E]/30 p-6 sm:p-12 shadow-2xl shadow-[#C8A96E]/10 overflow-hidden">
            ...
            <div className="text-center max-w-2xl mx-auto">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white font-serif-heading">
                Logo & Branding{" "}
                <span className="gold-gradient-text">Inquiry Form</span>
              </h2>
              <p className="mt-2 text-sm sm:text-base text-gray-300">
                Complete this quick 3-step brief to send your project details
                directly to our creative studio.
              </p>
            </div>
              ...
              <div>
                ...
                <div className="mt-8 mb-10 max-w-md mx-auto">
                  <div className="flex items-center justify-between text-xs font-semibold text-gray-400 mb-2">
                    <span className={step >= 1 ? "text-[#C8A96E]" : ""}>
                      Step 1: Services
                    </span>
                    <span className={step >= 2 ? "text-[#C8A96E]" : ""}>
                      Step 2: Budget
                    </span>
                    <span className={step >= 3 ? "text-[#C8A96E]" : ""}>
                      Step 3: Contact
                    </span>
                  </div>
