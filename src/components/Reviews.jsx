        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {reviewsData.map((item, idx) => (
            <ScrollReveal key={item.id} animation="fade-up" delay={idx * 120}>
              <div className="relative p-8 rounded-2xl bg-[#0D0D0D] border border-white/5 hover:border-[#C8A96E]/40 transition-all duration-300 flex flex-col justify-between group hover:-translate-y-1 hover:shadow-2xl hover:shadow-[#C8A96E]/5 h-full">
                {/* Quote Icon */}
